...
export function SetlistPreview({ fontScale = 1 }: { fontScale?: number }) {
      ...
      <div
        ...
        >
          ...
          <h1 className="sl-print-title"
            style={{
              textAlign: "center", fontSize: `${Math.max(18, dimensions.height * 0.03) * fontScale}px`,
          ...
          <div className="sl-print-count"
            style={{
              textAlign: "center", fontSize: `${Math.max(10, dimensions.height * 0.01) * fontScale}px`,
                ...
                >
                  ...
                  {song.tonalite !== undefined && (
                    <span className="sl-print-tonalite"
                      style={{
                        flexShrink: 0,
                         fontSize: `${Math.max(10, dimensions.height * 0.015) * fontScale}px`,
                  ...
                  <span className="sl-print-song"
                    style={{
                      ...
                      maxWidth: "70%", overflow: "hidden", textOverflow: "ellipsis",
                       fontSize: `${Math.max(11, dimensions.height * 0.018) * fontScale}px`,
                      color: "black", fontWeight: "600",
                      fontFamily: "sans-serif", lineHeight: "1.1",
                    }}
                  >
                    <span className="sl-print-number" style={{ color: "#888", fontWeight: "400", marginRight: "4px",                        fontSize: `${Math.max(9, dimensions.height * 0.015) * fontScale}px` }}>
                  ...
                  {song.time !== undefined && (
                    <span className="sl-print-duration"
                      style={{
                        flexShrink: 0,
                         fontSize: `${Math.max(10, dimensions.height * 0.014) * fontScale}px`,
              ...
              <div
                style={{
                  flex: 1, display: "flex", alignItems: "center", justifyContent: "center",
                   color: "#999", fontSize: `${Math.max(14, dimensions.height * 0.015) * fontScale}px`,
                  fontStyle: "italic",
                }}
              >
          ...
          {songCount > 0 && (
            <div className="sl-print-total"
              style={{
                 textAlign: "center", fontSize: `${Math.max(10, dimensions.height * 0.012) * fontScale}px`,
            ...
            >
              ...
              {setlist?.stageTimeLimit != null && (
                   <span className="sl-print-limit" style={{ color: "#888", fontSize: `${Math.max(10, dimensions.height * 0.011) * fontScale}px`, marginLeft: "8px" }}>
